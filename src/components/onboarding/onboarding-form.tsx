...
export function OnboardingForm({ unitPreference }: Props) {
  const [state, action] = useActionState(completeOnboardingAction, {} as OnboardingFormState);
    ...
    <form action={handleFormSubmit} className="space-y-6">
            ...
            {goalType && (
              <>
                <Field
                  label="Goal title"
                  htmlFor="goalTitle"
                  errors={state.fieldErrors?.["goal.title"]}
                >
                  <Input
                    id="goalTitle"
                    type="text"
                ...
                {goalType === "STRENGTH" && (
                  <>
                    <Field
                      ...
                      errors={state.fieldErrors?.["goal.config.exerciseId"]}
                    >
                      <Input
                        id="exerciseName"
                        type="text"
                    ...
                    <Field
                      ...
                      errors={state.fieldErrors?.["goal.config.targetValueKg"]}
                    >
                      <Input
                        id="targetWeight"
                        type="number"
                ...
                {goalType === "BODY_METRIC" && (
                  <>
                    <Field
                      ...
                      htmlFor="metricType"
                      errors={state.fieldErrors?.["goal.config.metricType"]}
                    >
                      <select
                        id="metricType"
                    ...
                    <Field
                      label="Target value"
                      htmlFor="targetValue"
                      errors={state.fieldErrors?.["goal.config.targetValue"]}
                    >
                      <Input
                        id="targetValue"
                        type="number"
                ...
                {goalType === "CONSISTENCY" && (
                  <Field
                    ...
                    errors={state.fieldErrors?.["goal.config.workoutsPerWeek"]}
                  >
                    <Input
                      id="workoutsPerWeek"
                      type="number"
                ...
                <Field
                  ...
                  errors={state.fieldErrors?.["goal.targetDate"]}
                >
                  <Input
                    id="goalTargetDate"
                    type="date"
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            // Skip by submitting without goal
            setShowGoal(false);
            setGoalType("");
